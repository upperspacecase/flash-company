...
import { ensureSchema, getSql, getRecentFeedback, getFlashes, type FeedbackRow, type FlashRow } from "@/lib/db";
...
export default async function Dashboard() {
  ...
  let flashes: FlashRow[] = [];
  try {
    await ensureSchema();
    const sql = getSql();
    const [s, v, s30, r, fb, fl] = await Promise.all([
